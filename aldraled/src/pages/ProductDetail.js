            ...
            <div className="bg-gray-50 rounded-2xl p-5 md:p-6 space-y-4">
              ...
              <div ref={mainBtnRef} className="space-y-3 pt-1">
                ...
                <div className="flex gap-2.5">
                  ...
                  <button className="px-4 py-3.5 rounded-xl border border-gray-200 text-gray-600 font-bold text-sm hover:bg-gray-50 transition-all">
              ...
              <div className="border-t border-gray-200 pt-4">
                <p className="text-xs font-semibold text-gray-500 mb-2">Grotere aantallen & meer korting?</p>
                <div className="flex gap-2">
                  {BULK_DISCOUNTS.map((b, i) => (
                    <div key={i} className="flex-1 bg-white rounded-xl border border-gray-200 px-3 py-2.5 text-center">
                      <p className="text-base font-bold text-gray-900">{b.qty}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="py-6 md:py-8">
            ...
            {activeTab === 'Specificaties' && (
              <div>
                <h2 className="text-lg font-bold text-gray-900 mb-5">Specificaties</h2>
                {specs.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-0">
                    {specs.map((spec, i) => (
                      <div key={i} className={`flex items-center justify-between py-3 ${i < specs.length - 1 ? 'border-b border-gray-50' : ''}`}>
                        <span className="text-sm text-gray-500">{spec.label}</span>
